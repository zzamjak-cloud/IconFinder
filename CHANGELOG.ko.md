...
### Added
- 11개 언어 다국어 지원(i18n): 영어, 한국어, 일본어, 중국어 간체, 중국어 번체, 스페인어, 프랑스어, 독일어, 러시아어, 포르투갈어, 이탈리아어
  - 첫 실행 시 OS 로케일에서 표시 언어를 자동 감지하며, 설정 다이얼로그에서 변경 가능
  - 선택한 언어는 Tauri Store에 저장되어 유지됨
